...
<div class="padd_div">
    <div class="col-md-12 header">
      <h4 class="staff_head">Labour's List</h4>
    </div>
    <div class="table-responsive">
      <table width="100%" id="table7">
        <thead>
          <tr class="bold">
          <th class="th_div">#</th>
          <th class="th_div">Labour Name</th>
          <th class="th_div">Mobile Number</th>
          <th class="th_div">Address</th>
          <th class="th_div">Date of Birth</th>
          <th class="th_div">Working Place</th>
          <th class="th_div">Crusher Place</th>
          </tr>
        </thead>
        <tbody id="rg_ls">
      <?php   
