...
<table width="100%" id="table3">
    ...
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['equipmenttype_name']; ?></td>
    </tr>
    <tr>
    <td>Equipment can carry Load</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['equipment_load']; ?></td>
    </tr>
    <tr>
    <td>Mileage Calculation</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['mileage_km'].'/'.$mainlist[0]['mileage_hr']; ?></td>
    </tr>
    <tr>
    <td>Reading Type</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['reading_km'].'/'.$mainlist[0]['reading_hr']; ?></td>
    </tr>
    <tr>
    <td>Nature of Work</td>
    <td style="font-weight: 100;"><?php echo get_equipmentnature($mainlist[0]['equipmentnature']); ?></td>
    </tr>
    <tr>
    <td>Designation</td>
