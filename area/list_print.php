    ...
    <div class="table-responsive">
      <table width="100%" id="table7">
        <thead>
          ...
          <th class="th_div">This Area containing under - Area</th>
          <th class="th_div">Under Area</th>
          <th class="th_div">Approximate km from Crusher</th>
          <th class="th_div">Area allows limit Radius</th>
          </tr>
        </thead>
        <tbody id="rg_ls">
      <?php   
        $select_purchaseentry = $pdo_conn->prepare("SELECT * FROM area_creation ORDER BY area_id DESC");
