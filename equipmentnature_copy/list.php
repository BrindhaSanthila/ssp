                          ...
                          <tr>
							...
							<td><?php echo $value['outturn'];?></td>
              				<td><?php echo $value['active_status'];?></td>
                           	<td> 
						  <a href="#" title="View" id="staff_view_modal" onclick="staff_view_modal('equipmentnature/view.php','<?php echo $value['employee_id'];?>')" data-toggle="modal" data-target="#staff_view"><i class="fa fa-eye" aria-hidden="true"></i></a>
                          
						  <a href="index.php?file=equipmentnature/update&employee_id=<?php echo $value['employee_id']?>" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>  
                          	
                          <a href="#" id="<?php echo $value['employee_id']?>" onclick="del(<?php echo $value['employee_id']?>)" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
...
function staff_view_modal(url,employee_id){
	window.open(url+'?employee_id='+employee_id,'onmouseover','height=650,width=950,scrollbars=yes,resizable=no,left=250,top=250,toolbar=no,location=no,directories=no,status=no,menubar=no');  
}
