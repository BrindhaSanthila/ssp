...
$random_no=rand(100000,999999); 
		...
		$select_seg=$pdo_conn->prepare("SELECT * FROM segment where segment_id ='".$chem_use['segment_id']."'");
		$select_seg->execute();
		$selectseg = $select_brand->fetchAll();
 ?>
                        
<div class="row" id="sub-frm" style="overflow: scroll;">
<div class="list" id="">
...
<table class="table table-bordered table-striped" width="100%">
	...
	<tbody>
		...
		<tr>
            ...
            <td>
            	<select class="form-control select2 item_name" name="category_id" id="category_id" onchange="segment_list(category_id.value,<?php echo $chem_use[0]['segment_id'] ?>)" required style="width: 270px;">
    ...
    $cust_id = $_GET['customer_id'];
	  ...
	  $pdo_chem_use = $pdo_conn->prepare("SELECT * FROM chemical_using where delete_status!='1' AND customer_id=$cust_id ORDER BY chemical_using_id DESC");
