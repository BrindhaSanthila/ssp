...
<div class="padd_div">
    <div class="col-md-12 header">
      <h4 class="staff_head">Running Status List</h4>
    </div>
    <div class="table-responsive">
      <table width="100%" id="table7">
        <thead>
          <tr class="bold">
          <th class="th_div">#</th>
          <th class="th_div">Running Status Name</th>
          <th class="th_div">Opening & Closing Required</th>
          <th class="th_div">Required Work Remarks</th>
          </tr>
        </thead>
        <tbody id="rg_ls">
      <?php   
