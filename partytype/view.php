...
<table width="100%" id="table3">
    ...
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['partytype_name']; ?></td>
    </tr>
    <tr>
    <td>Required Company Name</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['req_comp_name'];; ?></td>
    </tr>
    <tr>
    <td>Required Contact Person</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['req_person_name']; ?></td>
    </tr>
    <tr>
    <td>Required Mobile No</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['req_mobile_no']; ?></td>
    </tr>
    <tr>
    <td>Required GST No</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['req_gst']; ?></td>
    </tr>
