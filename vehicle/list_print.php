...
<div class="padd_div">
    <div class="col-md-12 header">
      <h4 class="staff_head">Vehicle's List</h4>
    </div>
    <div class="table-responsive">
      <table width="100%" id="table7">
        <thead>
          <tr class="bold">
          <th class="th_div">#</th>
          <th class="th_div">Vehicle Code</th>
          <th class="th_div">Registration No</th>
          <th class="th_div">Equipment Type</th>
          <th class="th_div">Maximum Load Capacity</th>
          <th class="th_div">Mileage Tolerance</th>
          </tr>
        </thead>
        <tbody id="rg_ls">
      <?php   
