...
<table width="100%" id="table3">
    ...
    <tr>
    <td>Vehicle Code</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['vehicle_code']; ?></td>
    </tr>
    <tr>
    <td>Registration No</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['registration_no'];; ?></td>
    </tr>
    <tr>
    <td>Equipment Type</td>
    <td style="font-weight: 100;"><?php echo get_equipmenttype($mainlist[0]['equipmenttype']); ?></td>
    </tr>
    <tr>
    <td>Maximum Load Capacity</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['max_units'].'/'.$mainlist[0]['max_tonnes']; ?></td>
    </tr>
    <tr>
    <td>Mileage Tolerance</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['mileage_tolerance']; ?></td>
    </tr>
    <tr>
    <td>Status</td>
