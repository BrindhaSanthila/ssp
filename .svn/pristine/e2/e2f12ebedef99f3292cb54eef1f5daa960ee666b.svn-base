...
/************************************* VIEW ********************************************/
	...
	$main_list = $pdo_conn->prepare("SELECT * FROM shift_creation WHERE shift_id ='".$_GET['shift_id']."'");
	$main_list->execute();
...
<table width="100%" id="table3">
    ...
    <tr>
    <td>Shift Name</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['shift_name']; ?></td>
    </tr>
    <tr>
    <td>Shift Start Time</td>
    <td style="font-weight: 100;"><?php if($mainlist[0]['shift_starttime']!='00:00:00') echo date('H:i', strtotime($mainlist[0]['shift_starttime'])); else echo '--';  ?></td>
    </tr>
    <tr>
    <td>Shift End Time</td>
    <td style="font-weight: 100;"><?php if($mainlist[0]['shift_endtime']!='00:00:00') echo date('H:i', strtotime($mainlist[0]['shift_endtime'])); else echo '--'; ?></td>
    </tr>
    <tr>
    <td>Status</td>
