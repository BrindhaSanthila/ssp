...
<div class="padd_div">
    <div class="col-md-12 header">
      <h4 class="staff_head">Party Type's List</h4>
    </div>
    <div class="table-responsive">
      <table width="100%" id="table7">
        <thead>
          <tr class="bold">
          <th class="th_div">#</th>
          <th class="th_div">Party Type Name</th>
          <th class="th_div">Required Company Name</th>
          <th class="th_div">Required Contact Person</th>
          <th class="th_div">Required Contact Person Mobile No</th>
          <th class="th_div">Required GST No</th>
          </tr>
        </thead>
        <tbody id="rg_ls">
      <?php   
