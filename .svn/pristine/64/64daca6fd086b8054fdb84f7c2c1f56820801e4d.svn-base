...
<table width="850px" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="27" colspan="5" align="center" class="style6"><?php echo "Order List"; ?></td>
    </tr>
            ...
            <table border="1" width="100%"  align="center" cellpadding="0" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th width="50"  scope="col">Invoice No</th>
                        <th width="168" align="center"   > Customer Name </th>
                        <th width="168" align="center"   > Executive Name </th>
                         <th width="168" align="center"   > Amount </th>
                        <th width="168" align="center"   > Delivery Status </th>
				...
				<?php 
                   ...
                   // echo "SELECT * FROM order_confirm where $query group by enquiry_id ORDER BY order_id  DESC";
                //echo " SELECT * FROM invoice where status='1' $query group by invoice_no  order by invoice_id desc";
						$pdo_enquiry = $pdo_conn->prepare("SELECT * FROM invoice where status='1' $query group by invoice_no  order by invoice_id desc");
                        $pdo_enquiry->execute();
					...
					<td> <?php if($value['delivered_status']!='1') {echo "Undelivered"; } else {echo "Delivered";}?></td>
