					...
					<tbody>						
                        ...
                        $pdf = $pdf_file->fetch();
                           ...
                           <tr>
						    ...
						    <td><?php if($pdf['pdf']!=""){?><a href="javascript:pdf_view('<?php echo $image_path_back."upload/enquiry/".$pdf['pdf']; ?>');" title="View Material"><img src="images/pdf.png" id='picture' name='picture' style="width: 50px; height: 50px;" ></a><?php } else { ?><img src="images/images.jpg" id='picture' name='picture' style="width: 50px; height: 50px;" ><?php } ?><?php if($pdf['pdf1']!=""){?><a href="javascript:pdf_view('<?php echo $image_path_back."upload/enquiry/".$pdf['pdf1']; ?>');" title="View Material" /><img src="images/pdf.png" id='picture' name='picture' style="width: 50px; height: 50px;" ></a><?php } ?></td>
