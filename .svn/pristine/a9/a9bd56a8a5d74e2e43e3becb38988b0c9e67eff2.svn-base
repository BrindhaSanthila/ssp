...
$sql_count = "SELECT COUNT(*) FROM enquiry_item WHERE random_sc='$random_sc' and random_no='$random_no' and item_id='2'";
$res_count = $pdo_conn->prepare($sql_count);
$count_enq= $res_count->fetchColumn();
if($count_enq==0)
{
