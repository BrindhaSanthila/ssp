...
<table width="100%" id="table3">
    ...
    <tr>
    <td>Area Name</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['area_name']; ?></td>
    </tr>
    <tr>
    <td>This Area containing under - Area</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['under_area'];; ?></td>
    </tr>
    <tr>
    <td>Under Area</td>
    <td style="font-weight: 100;"><?php echo get_city($mainlist[0]['under_area_id']); ?></td>
    </tr>
    <tr>
    <td>Approximate km from Crusher</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['crusher_km']; ?></td>
    </tr>
    <tr>
    <td>Area allows limit Radius</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['limit_radius']; ?></td>
    </tr>
    <tr>
    <td>Status</td>
