...
<table width="100%" id="table3">
    ...
    <tr>
    <td>Employee Name</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['employee_name']; ?></td>
    </tr>
    <tr>
    <td>Mobile No</td>
    ...
    <tr>
    <td>Designation</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['designation']; ?></td>
    </tr>
    <tr>
    <td>Employee required Mobile Access</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['employee_mobile']; ?></td>
    </tr>
    <tr>
    <td>Employee required Web Access</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['employee_web']; ?></td>
    </tr>
    <tr>
    <td>Status</td>
    ...
    <tr>
    <td>ID Proof</td>
    <td style="font-weight: 100;"><?php if(($mainlist[0]['id_proof']!='') ||($mainlist[0]['id_proof']!=NULL)){ ?>   <a href="javascript:pdf_view('<?php echo $image_path_back."staff/".$mainlist[0]['id_proof']; ?>');" title="View Material" ><img  src="<?php echo $image_path_back."staff/".$mainlist[0]['id_proof']; ?>" style="height:60px; width:60px;"  ></a><?php } else { echo "No Image"; } ?></td>
