...
/************************************* VIEW ********************************************/
	...
	$main_list = $pdo_conn->prepare("SELECT * FROM order_entry WHERE order_no ='".$_GET['order_no']."'");
	$main_list->execute();
...
<table width="100%" id="table3">
    ...
    <td>Quantity</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['quantity']; ?></td>
    </tr>
    <tr>
    <td>Rate</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['rate']; ?></td>
    </tr>
    <td>Delivry Area</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['delivery_area']; ?></td>
    </tr>
    <tr>
    <td>Delivery Date</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['delivery_date']; ?></td>
    </tr>
    <td>Payment Mode</td>
    ...
    <tr>
    <td>Status</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['status']; ?></td>
    </tr>
    <td>Amount</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['amount']; ?></td>
    </tr>
