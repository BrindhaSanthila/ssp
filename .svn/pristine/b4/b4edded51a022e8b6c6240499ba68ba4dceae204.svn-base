...
<div class="padd_div">
    <div class="col-md-12 header">
      <h4 class="staff_head">Materials's List</h4>
    </div>
    <div class="table-responsive">
      <table width="100%" id="table7">
        <thead>
          ...
          <th class="th_div">Unit of Measurement</th>
          <th class="th_div">Alternative Unit</th>
          <th class="th_div">Material Production From</th>
          </tr>
        </thead>
        <tbody id="rg_ls">
      <?php   
