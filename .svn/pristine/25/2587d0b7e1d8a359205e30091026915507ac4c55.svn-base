...
<table width="100%" id="table3">
    ...
    <tr>
    <td>Running Status Name</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['runningstatus_name']; ?></td>
    </tr>
    <tr>
    <td>Opening & Closing Required</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['openclose_req'];; ?></td>
    </tr>
    <tr>
    <td>Required Work Remarks</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['workremarks_req']; ?></td>
    </tr>
    <tr>
    <td>Status</td>
