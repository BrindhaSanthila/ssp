...
<aside class="main-sidebar">
	...
	?>
		<li class="treeview">
			<a href="#">
			<i class="fa fa-first-order left3"></i>
			<span style="color: black;font-weight: 600;">Report</span>
			<span class="pull-right-container">
			<i class="fa fa-angle-right pull-right"></i>
			</span>
			</a>
	...
	foreach($userform as $record) { 
	   if($salesorder == $record['short_name']) { ?>
		...
		<?php if($salesorder == $record['short_name']) { ?>
			<li>
			<a href="index.php?file=collectionreport/list">
			<div class="menu-info">
			<h4 class="control-sidebar-subheading"> - Collection Report</h4>
			</div>
			</a> 
			</li>
		<?php $salesorder = '';} ?>
		<li>
			<a href="index.php?file=report/list">
			<div class="menu-info">
			<h4 class="control-sidebar-subheading"> -Sales Report</h4>
			</div>
			</a> 
			</li>
			<li>
			<a href="index.php?file=report/list">
			<div class="menu-info">
			<h4 class="control-sidebar-subheading"> - Stock Report</h4>
			</div>
			</a> 
			</li>
		<?php  }  ?>
