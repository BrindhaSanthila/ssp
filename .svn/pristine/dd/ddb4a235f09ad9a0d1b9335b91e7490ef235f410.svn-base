...
<div class="col-md-12 header">
    <h3>Equipment Nature Details</h3>
</div>
<div class="padd_div">
...
<table width="100%" id="table3">
    ...
    <tr>
    <td>Work Name</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['equipmentnature_name']; ?></td>
    </tr>
    <tr>
    <td>Outturn</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['outturn']; ?></td>
    </tr>
    <tr>
    <td>Status</td>
