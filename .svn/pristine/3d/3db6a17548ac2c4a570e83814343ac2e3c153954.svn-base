...
<?php
	...
	if(isset($_GET['equipmentnature_id'])){
	$main_list = $pdo_conn->prepare("SELECT * FROM equipmentnature_creation WHERE equipmentnature_id ='".$_GET['equipmentnature_id']."'");
	$main_list->execute();
	$mainlist = $main_list->fetchAll();	
		$work_name		    = $mainlist[0]['equipmentnature_name'];
		$outturn		    = $mainlist[0]['outturn'];
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="outturn" id="outturn_yes" value="Yes" <?php if($outturn == 'Yes') { echo 'checked'; } ?>>
                                        <label class="form-check-label" for="outturn_yes">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="outturn" id="outturn_no" value="No" <?php if($outturn == 'No') { echo 'checked'; } ?>>
