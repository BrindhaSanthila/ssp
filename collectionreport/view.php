...
/************************************* VIEW ********************************************/
	...
	$main_list = $pdo_conn->prepare("SELECT * FROM sales_entry WHERE sales_no ='".$_GET['sales_no']."'");
	$main_list->execute();
...
<table width="100%" id="table3">
    <tr>
    <td>Sales No</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['sales_no']; ?></td>
    </tr>
    <tr>
    <td>Sales Date</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['sales_date']; ?></td>
    </tr>
    <tr>
    <td>Order No</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['order_no']; ?></td>
    </tr>
    <tr>
    <td>Order Date</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['order_date']; ?></td>
    </tr>
    <tr>
    <td>Seller Name</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['seller_name']; ?></td>
    </tr>
    <tr>
    <td>Party ID</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['party_id']; ?></td>
    </tr>
    <tr>
    <td>Area</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['area']; ?></td>
    </tr>
    <tr>
    <td>Material ID</td>
    <td style="font-weight: 100;"><?php echo $mainlist[0]['material_id']; ?></td>
    </tr>
    <tr>
    <td>Order Quantity</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['order_quantity']; ?></td>
    </tr>
    <tr>
    <td>Pending Quantity</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['pending_quantity']; ?></td>
    </tr>
    <td>Payment Mode</td>
    <td style="font-weight: 100;"> <?php echo $mainlist[0]['payment_mode']; ?></td>
    </tr>
