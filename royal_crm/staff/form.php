					...
					<?php if($_GET['staffcreation_id']!=""){ ?> <div class="staff_img"><img class="img_staff" id="image"src="upload/staff/<?php echo $image; ?>"/> <?php } else {?><img class="img_staff" id="image"/> <?php }?> 
                           ...
                           <!--  <script type="text/javascript">
							...
							<div class="col-md-12"><br><br>
									...
									<button type="button" id="add" class="float-right btn btn-success" onclick="staffcreation_cu('<?php echo $_GET['staffcreation_id']?>','Update')">Update</button>
									<?php }else{?>
									<button type="button" id="add" class="float-right btn btn-success" onclick="staffcreation_cu('','Add')">Save</button>
									<?php }?>
							</div>
