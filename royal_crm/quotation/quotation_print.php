...
<table width="850px" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="27" colspan="5" align="center" class="style6"><?php echo "Quotation List"; ?></td>
    </tr>
   </table>
    ...
    <tr>
        <td>
            <table border="1" width="850px%"  align="center" cellpadding="0" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th width="168" align="center"   > Executive Name </th>
                          <th width="168" align="center"   > Quotation amount </th>
				...
				<?php 
                        //$query = "  Date between '".$_GET['from_date']."' AND '".$_GET['to_date']."'";
                    //echo "SELECT * FROM quotation where $query group by enquiry_id ORDER BY quotation_id  DESC";
                        
						$pdo_enquiry = $pdo_conn->prepare("SELECT * FROM quotation where $query group by enquiry_id ORDER BY quotation_id  DESC");
						$pdo_enquiry->execute();
